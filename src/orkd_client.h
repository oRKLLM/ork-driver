...
typedef struct { uint32_t kind; uint64_t weight_id; int M, N; uint32_t abytes, bbytes, cbytes; int mult, shift, group; double in_scale, out_scale, b_scale; const void *A, *B; void *C; int a_src, b_src, c_keep; } orkd_seq_op_c;
