 ...
 * Uses ork_i16_npu_add with env reg overrides (ORK_ADD16_R48/R84/R88/R78). Feeds (a=ramp,b=0) then (a=0,b=ramp)
...
int main(void){
    ...
    if(ork_i16_npu_add(c,a,b,M,N,0.001,0.001,0.001,out,&us)){printf("wedge\n");ork_npu_free(c);return 1;}
    printf("A-path (b=0):  ");
