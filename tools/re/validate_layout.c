 ...
 * native (N/32,K/32,32,32)); replays rkllm's CAPTURED regcmd (/tmp/mm_regcmd.txt) via ork_i8_npu_replay;
...
int main(int argc,char**argv){
    ...
    int r=ork_i8_npu_replay(c,rc,rn,M,K,N,Ap,(int)asz,Wp,(int)wsz,Craw,1,&us);
