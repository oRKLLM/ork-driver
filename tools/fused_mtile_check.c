 ...
 * run ork_mm_run_i8_silu at M>64 with the big tile (mc=mg_max*64, one submit) vs forced mc=64 (2+ submits),
...
int main(int argc,char**argv){
    ...
    int r1=ork_mm_run_i8_silu(c,w,M,A,o64,RM,RS,OB,IO,C4,NULL,0);
    unsetenv("ORK_FUSED_MTILE");                     /* default = mg_max*64 (one big tile) */
    int r2=ork_mm_run_i8_silu(c,w,M,A,oBig,RM,RS,OB,IO,C4,NULL,0);
