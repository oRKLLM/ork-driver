...
PREFIX  ?= /usr/local
CORE    := src/npu.c src/npu/core/buf.c src/npu/core/device.c src/npu/core/domain.c src/npu/core/mode.c src/npu/core/prof.c src/npu/core/sched.c src/npu/core/submit.c src/npu/f16.c src/npu/i4.c src/npu/ssm.c src/soc.c src/soc/rk3588.c src/soc/rk3576.c src/neon_activations.c src/ork_ops.c
